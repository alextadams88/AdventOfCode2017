...
public class puzzle16 {
	...
	private static int highestEver;
	...
	public static void main(String[] args) {
		try{
			...
			System.out.println(highestEver);
			input.close();
		}
	...
	public static void processInstruction(Instruction instruction){
		...
		if (registers.get(instruction.register) > highestEver){
			highestEver = registers.get(instruction.register);
		}
	}
